    ...
    <SettingsShell active="Perfil da clínica">
      ...
      {state === "default" ? (
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Card><CardHeader><CardTitle>Dados fiscais</CardTitle></CardHeader><CardContent className="space-y-2 text-sm"><p><strong>CNPJ:</strong> {clinicSettingsProfileMock.fiscalInfo.cnpj}</p><p><strong>Inscrição municipal:</strong> {clinicSettingsProfileMock.fiscalInfo.municipalRegistration}</p><p><strong>Endereço fiscal:</strong> {clinicSettingsProfileMock.fiscalInfo.address}</p></CardContent></Card>
