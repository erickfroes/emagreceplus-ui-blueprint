...
const throwUiOnly = (): never => {
  throw new Error(UI_ONLY_ERROR);
};

class FutureSupabaseAuthRepository implements AuthRepository {
  async getSession(): Promise<AuthSession | null> {
    return throwUiOnly();
  }
}
class FutureSupabaseTenantRepository implements TenantRepository {
  async listTenants(): Promise<TenantListDto> {
    return throwUiOnly();
  }
  async getTenantDetail(id: string): Promise<TenantDetailDto | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabaseDashboardRepository implements DashboardRepository {
  async getOverview(): Promise<{
    state: "default" | "loading" | "empty" | "error" | "forbidden";
    kpiIds: string[];
  }> {
    return throwUiOnly();
  }
}
class FutureSupabaseCrmRepository implements CrmRepository {
  async listLeads(): Promise<CrmListDto> {
    return throwUiOnly();
  }
  async getLeadDetail(id: string): Promise<CrmDetailDto | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabasePatientRepository implements PatientRepository {
  async listPatients(): Promise<PatientListResult> {
    return throwUiOnly();
  }
  async getPatientDetail(id: string): Promise<PatientDetail | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabaseSchedulingRepository implements SchedulingRepository {
  async listAppointments(): Promise<SchedulingListDto> {
    return throwUiOnly();
  }
  async getAppointmentDetail(id: string): Promise<SchedulingDetailDto | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabaseClinicalRepository implements ClinicalRepository {
  async listRecords(): Promise<ClinicalListDto> {
    return throwUiOnly();
  }
  async getRecordDetail(id: string): Promise<ClinicalDetailDto | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabaseNutritionRepository implements NutritionRepository {
  async listPlans(): Promise<NutritionListDto> {
    return throwUiOnly();
  }
  async getPlanDetail(id: string): Promise<NutritionDetailDto | null> {
    void id;
    return throwUiOnly();
  }
}
class FutureSupabasePrescriptionRepository implements PrescriptionRepository {
...
class FutureSupabaseDocumentRepository implements DocumentRepository {
...
class FutureSupabaseFinanceRepository implements FinanceRepository {
...
class FutureSupabasePackageRepository implements PackageRepository {
...
class FutureSupabaseInventoryRepository implements InventoryRepository {
...
class FutureSupabaseReportRepository implements ReportRepository {
...
class FutureSupabaseNotificationRepository implements NotificationRepository {
...
class FutureSupabaseChatRepository implements ChatRepository {
